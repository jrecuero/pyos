...
class GameActorDisplay(GObject):
    ...
    def __init__(self, actor, x, y, dx, dy, **kwargs):
        ...
        self.surface_health = pygame.surface.Surface((SPRITE_SIZE, SPRITE_SIZE))
        self.surface_damage = pygame.Surface((SPRITE_SIZE, SPRITE_SIZE))
        self.surface_defense = pygame.Surface((SPRITE_SIZE, SPRITE_SIZE))
        self.surface_mind = pygame.Surface((SPRITE_SIZE, SPRITE_SIZE))
        self.surface_damage_skills = pygame.Surface((SPRITE_SIZE, SPRITE_SIZE))
        self.surface_defense_skills = pygame.Surface((SPRITE_SIZE, SPRITE_SIZE))
        self.surface_mind_skills = pygame.Surface((SPRITE_SIZE * 3, SPRITE_SIZE))

    def update(self, surface, **kwargs):
        """update calls update method for all scenes and  graphical objects.
        """
        text_pos = (10, 10, SPRITE_SIZE, SPRITE_SIZE)
        ...
        health_delta = (self.actor.health / self.actor.max_health) * SPRITE_SIZE
        self.surface_health.fill(Color.WHITE)
        pygame.draw.rect(
            self.surface_health, (0, 255, 0, 0), (0, 0, SPRITE_SIZE, int(health_delta))
        )
        pygame.draw.rect(
            self.surface_health, BLACKY, (0, 0, SPRITE_SIZE, SPRITE_SIZE), 1
        )
        ...
        for skill in self.actor.damage_skills:
            ...
            if skill.image:
                self.surface_damage_skills.blit(
                    skill.image, (0, 0, SPRITE_SIZE, SPRITE_SIZE)
                )
        ...
        for skill in self.actor.defense_skills:
            ...
            if skill.image:
                self.surface_defense_skills.blit(
                    skill.image, (0, 0, SPRITE_SIZE, SPRITE_SIZE)
                )
        ...
        for index, skill in enumerate(self.actor.mind_skills):
            ...
            if skill.image:
                self.surface_mind_skills.blit(
                    skill.image, (start_x, 0, SPRITE_SIZE, SPRITE_SIZE)
                )
            skill_skill_text = self.font.render(f"{skill.threshold}", True, Color.WHITE)
            self.surface_mind_skills.blit(
                skill_skill_text, (start_x + 10, 10, SPRITE_SIZE, SPRITE_SIZE)
            )
            if skill.can_run(self.actor):
                pygame.draw.rect(
                    self.surface_mind_skills,
                    (0, 255, 0),
                    (start_x, 0, SPRITE_SIZE, SPRITE_SIZE),
                    5,
                )
            else:
                pygame.draw.rect(
        ...
        self.image.blit(self.surface_health, (100, 0, SPRITE_SIZE, SPRITE_SIZE))
        self.image.blit(self.surface_damage, (164, 0, SPRITE_SIZE, SPRITE_SIZE))
        self.image.blit(self.surface_defense, (228, 0, SPRITE_SIZE, SPRITE_SIZE))
        self.image.blit(self.surface_mind, (292, 0, SPRITE_SIZE, SPRITE_SIZE))
        self.image.blit(
            self.surface_damage_skills, (356 + 10, 0, SPRITE_SIZE, SPRITE_SIZE)
        )
        self.image.blit(
            self.surface_defense_skills, (420 + 10, 0, SPRITE_SIZE, SPRITE_SIZE)
        )
        self.image.blit(
            self.surface_mind_skills, (484 + 10, 0, SPRITE_SIZE, SPRITE_SIZE)
        )
